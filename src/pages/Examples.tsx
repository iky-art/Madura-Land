  ...
  const sidebar = (
    <>
      ...
      <SidebarGroup label="Lainnya">
        ...
        <Link to="/sosial" className="border-l-2 border-transparent py-1.5 pl-2.5 text-sm text-muted transition-colors duration-150 hover:border-border hover:text-text">
          Sosial Media
        </Link>
      </SidebarGroup>
    </>
